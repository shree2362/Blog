    ...
    <div class="footer">
        ...
        <div class="socials">
            <a href="https://www.facebook.com/tiny.blogger19"><i class="fab fa-facebook"></i></a>
            <a href="https://www.instagram.com/tiny_blogger19/"><i class="fab fa-instagram"></i></a>
        </div>
        </div>
        ...
        <div class="footer-bottom">
            &copy; tinyblogger.com | Desinged by Revengers
        </div>
    </div>
    <!--//footer-->